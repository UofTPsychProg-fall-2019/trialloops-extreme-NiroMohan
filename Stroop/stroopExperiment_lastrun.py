...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath="/Users/niroshicamohanathas/Desktop/Master's Program/Stroop/stroopExperiment_lastrun.py",
...
InstructionsComponents = [InstruText, key_resp_2]
